...
namespace Shh {
	...
	public:
		...
		*/
		...
		/** Flush the stream; this makes further operations invalid. */
	...
	*/
	class _Shh_Export MemoryDataStream : public DataStream
	{
	protected:
    ...
    */
    ...
    /** Common subclass of DataStream for handling data from 
		std::basic_istream.
	*/
	class _Shh_Export FileStreamDataStream : public DataStream
	{
	protected:
	...
	*/
	class _Shh_Export FileHandleDataStream : public DataStream
	{
	protected:
		FILE* mFileHandle;
	public:
